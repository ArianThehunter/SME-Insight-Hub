<!--
  Auth layout — Clean centered layout for login/register pages (no sidebar/topnav).
-->
<script lang="ts">
	let { children } = $props();
</script>
...
<style>
	...
	.auth-bg-decoration {
		...
		background:
			...
			radial-gradient(ellipse 50% 30% at 10% 90%, rgba(16, 185, 129, 0.06) 0%, transparent 40%);
		pointer-events: none;
	}
