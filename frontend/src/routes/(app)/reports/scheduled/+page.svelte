	...
	let schedules = $state<ScheduledItem[]>([
		{
			...
			recipients: 'director@acmecorp.com.bd',
		...
		{
			id: '2',
			name: 'Monthly VAT Return Digest',
			recipients: 'accountant@acmecorp.com.bd',
		...
		{
			id: '3',
			name: 'Daily Cash Movement Alert',
			recipients: 'finance@acmecorp.com.bd',
	...
	<header class="page-header">
		<div>
			...
			<p class="page-subtitle">
				Automate automated email deliveries of your core financial and operational reports
			</p>
		</div>
