...
<script lang="ts">
	...
	const aiInsights = [
		{
			type: 'opportunity',
			text: 'Gross Profit margins are strong at 76.1% due to fabric cost optimization. Reinvest 10% in marketing.'
		},
		{
			type: 'warning',
			text: 'Logistics costs rose 12% this month due to emergency shipments. Centralizing inventory in Rajshahi can save ৳18,000/mo.'
		},
		{
			type: 'success',
			text: 'LTV to CAC ratio is at 10.7x (excellent). Ideal range for scaling ad-spend on digital channels.'
		}
	];
</script>
	...
	<header class="page-header">
		<div>
			...
			<p class="page-subtitle">
				Cross-module operational and financial performance summary for company executives
			</p>
		</div>
	</header>
	...
	<div class="content-grid animate-fade-in-up">
		...
		<div class="insights-card">
			...
			<p class="insights-desc">
				Automated analysis highlighting optimizations, risks, and recommendations.
			</p>
