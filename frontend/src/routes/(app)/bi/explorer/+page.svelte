	...
	<header class="page-header">
		<div>
			...
			<p class="page-subtitle">
				Interactive multidimensional drilldown across your enterprise data
			</p>
		</div>
	...
	<div class="card explorer-controls">
		<div class="controls-row">
			<div class="entity-selector">
				<button
					class="tab-btn"
					class:active={entity === 'orders'}
					onclick={() => (entity = 'orders')}>Orders</button
				>
				<button
					class="tab-btn"
					class:active={entity === 'customers'}
					onclick={() => (entity = 'customers')}>Customers</button
				>
				<button
					class="tab-btn"
					class:active={entity === 'inventory'}
					onclick={() => (entity = 'inventory')}>Inventory</button
				>
				<button
					class="tab-btn"
					class:active={entity === 'expenses'}
					onclick={() => (entity = 'expenses')}>Expenses</button
				>
			</div>
