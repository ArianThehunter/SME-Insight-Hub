	...
	const metrics = [
		{
			...
			change: '+14.2%',
			up: true,
			subtitle: 'Average per enterprise account'
		},
		{
			...
			change: '-6.8%',
			up: false,
			subtitle: 'Down across digital channels'
		},
		{
			label: 'LTV / CAC Ratio',
			value: '13.2x',
		...
		},
		{
			...
			change: '+3.1%',
			up: true,
			subtitle: 'Textiles & Electronics lead'
		}
	];
...
<svelte:head>
	...
	<meta
		name="description"
		content="Advanced business intelligence, unit economics, and regional sales distribution for Bangladesh SMEs."
	/>
</svelte:head>
	...
	<header class="page-header">
		<div>
			...
			<p class="page-subtitle">
				Unit economics, cross-category performance, and geographic revenue distribution
			</p>
		</div>
					...
					<div class="category-item">
						<div class="category-info">
							<div class="cat-name-row">
								...
								<span class="cat-revenue"
									>৳ {(cat.revenue / 100000).toFixed(1)} Lakh ({cat.share}%)</span
								>
							</div>
