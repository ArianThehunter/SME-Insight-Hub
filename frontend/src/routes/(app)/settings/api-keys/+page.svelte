	...
	let keys = $state<ApiKey[]>([
		{
			...
			tokenMasked: 'sme_live_9f81a7...4b28',
			created: 'Aug 1, 2026',
			lastUsed: '5 minutes ago'
		},
		{
			id: '2',
			name: 'E-commerce POS Webhook (WooCommerce)',
			tokenMasked: 'sme_live_3c92e1...8f14',
			created: 'Jul 15, 2026',
			lastUsed: '1 hour ago'
		}
	]);
...
<div class="page animate-fade-in">
	<header class="page-header">
		<div>
			...
			<p class="page-subtitle">
				Manage REST API credentials for syncing with external ERPs, POS systems, and ecommerce
			</p>
		</div>
	...
	<div class="card warning-card">
		...
		<div>
			...
			<p>
				API keys carry full read/write privileges on your organization's records. Keep them
				confidential and rotate them periodically.
			</p>
		</div>
	</div>
