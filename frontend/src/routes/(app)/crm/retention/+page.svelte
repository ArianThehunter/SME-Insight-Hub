...
<script lang="ts">
	...
	const retentionStats = [
		{
			...
			value: '86.4%',
			sub: '+3.2% vs previous quarter',
			good: true
		},
		{ label: 'Monthly Churn Rate', value: '2.1%', sub: 'Industry benchmark: 3.5%', good: true },
		{
			label: 'Accounts At Risk (>60d inactive)',
			value: '18 accounts',
			sub: 'Est. ৳ 34 Lakh exposure',
			good: false
		},
	...
	const atRiskAccounts = [
		{
			id: '1',
			name: 'Comilla Ceramics Ltd.',
			lastOrder: '64 days ago',
			ltv: '৳ 7,24,000',
			contact: 'M. A. Matin (+8801912-222222)',
			risk: 'High'
		},
		{
			id: '2',
			name: 'Tangail Handicrafts Export',
			lastOrder: '72 days ago',
			ltv: '৳ 4,35,000',
			contact: 'Begum Rokeya (+8801612-333333)',
			risk: 'High'
		},
		{
			id: '3',
			name: 'Barishal Marine Supplies',
			lastOrder: '58 days ago',
			ltv: '৳ 26,70,000',
			contact: 'Capt. Enamul (+8801512-333333)',
			risk: 'Medium'
		},
		{
			id: '4',
			name: 'Jessore Food Processing',
			lastOrder: '61 days ago',
			ltv: '৳ 9,56,000',
			contact: 'Tareq Aziz (+8801712-333333)',
			risk: 'High'
		}
	];
</script>
	...
	<header class="page-header">
		<div>
			...
			<p class="page-subtitle">
				Track account longevity, identify drop-off risk, and trigger proactive winback
			</p>
		</div>
	</header>
