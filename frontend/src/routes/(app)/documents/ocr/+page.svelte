...
<script lang="ts">
	...
	const demoDocuments = [
		{
			id: '1',
			name: 'INV-2026-0847.pdf',
			type: 'invoice',
			status: 'completed',
			confidence: 0.96,
			processed: '10 min ago',
			size: '1.2 MB'
		},
		{
			id: '2',
			name: 'BRAC_Bank_Statement_Jul.pdf',
			type: 'bank_statement',
			status: 'processing',
			confidence: null,
		...
		{
			id: '6',
			name: 'Invoice_Chittagong_Port.pdf',
			type: 'invoice',
			status: 'failed',
			confidence: null,
			processed: '3 hours ago',
			size: '2.1 MB'
		}
	];
...
<div class="page animate-fade-in">
	...
	<!-- Stats row -->
	<div class="stats-row">
		{#each [{ label: 'Total Processed', value: '247', color: 'accent' }, { label: 'Completed', value: '231', color: 'success' }, { label: 'Queued', value: '8', color: 'warning' }, { label: 'Failed', value: '8', color: 'danger' }] as stat}
			<div class="stat-card">
							...
							{#if doc.confidence}
								<div class="confidence">
									<div class="confidence-bar">
										<div
											class="confidence-fill {getConfidenceClass(doc.confidence)}"
