	...
	const modules = [
		{
			...
			accountant: [true, false, false, true],
		...
		},
		{
			...
			owner: [true, true, true, true],
			manager: [true, true, false, true],
			accountant: [true, true, true, true],
		...
		},
		{
			...
			owner: [true, true, true, true],
			manager: [true, true, false, true],
			accountant: [true, true, false, true],
			sales: [true, true, false, false],
			viewer: [true, false, false, false]
		},
		{
	...
	<header class="page-header">
		<div>
			...
			<p class="page-subtitle">
				Inspect privilege scopes (Read / Write / Delete / Export) across organizational roles
			</p>
		</div>
	</header>
